...
public class Example2Controller {
	...
	//http://localhost:8080/example2/request1?nm=John
	@GetMapping("/request1")
	public ModelAndView request1(@RequestParam(name="nm", required=false, defaultValue="Andrew") String name) {
		ModelAndView mov= new ModelAndView(EXAMPLE2_VIEW);
		mov.addObject("nm_in_model", name);
		return mov;
	}
	
	//http://localhost:8080/example2/request2/JOHN
